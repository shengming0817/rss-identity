...
仅支持 HTTP v2 和 fresh schema v9，无旧配置、旧库升级、v1 alias、legacy feature 或中央 downstream/client/Hydra 模式。旧候选验证与历史证据通过原 PR 和 Git 历史追溯，存放遵循[文档规则](documentation.md)；重新部署及真实产品迁移须由其独立任务闭合。
