...
历史候选证据见 [20260917 #2436 联合记录](verification/20260917-2436/README.md)。

历史 PR #1030 修复后的固定候选与 25 步真实 operator 记录见 [20260917 修复验证](verification/20260917-1030/README.md)。
