...
当前架构：[#2435 内嵌认证组件](adr/202609170001-2435-embedded-authentication.md)。2026-09-17 已按“彻底 / 不向后兼容 / 优雅简洁”复核并实施，[交付记录](../reviews/202609170600-2435-embedded-authentication.md)包含测试与内置审查处置；实时交接状态以 PR/看板为准。以下中央架构任务索引保留为历史来源，不代表当前组件运行模式。
