...
/// A validated upstream subject, not an Identity principal or a trusted product context.
...
impl UpstreamSubject {
    ...
    /// Verified upstream subject, never an Identity principal or an email-based association.
...
impl Provider {
    ...
    /// this in-memory seam supplies no durable login transaction or Identity authentication.
